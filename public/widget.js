...
(function () {
  ...
  style.textContent = [
    ...
    ".bubble{width:56px;height:56px;border-radius:50%;background:var(--lb-theme,#6d3ef7);color:#fff;",
    ...
    ".header{background:var(--lb-theme,#6d3ef7);color:#fff;padding:14px 12px;font-size:14px;font-weight:600;",
    ...
    ".msg.visitor{background:var(--lb-theme,#6d3ef7);color:#fff;align-self:flex-end;}",
    ...
    ".optionBtn{background:#fff;border:1.5px solid var(--lb-theme,#6d3ef7);color:var(--lb-theme,#6d3ef7);",
    ...
    ".contactForm input:focus{border-color:var(--lb-theme,#6d3ef7);}",
    ".contactForm button{background:var(--lb-theme,#6d3ef7);color:#fff;border:none;padding:10px;border-radius:10px;",
    ...
    ".inputRow button{border:none;background:var(--lb-theme,#6d3ef7);color:#fff;padding:0 16px;cursor:pointer;font-size:13px;}",
  ].join("");
